...
NO markdown, NO explanation, ONLY JSON.`;
  ...
  parseReceiptText(text: string, groupCurrency: string): ScanReceiptResult {
    ...
    const currencyMatch = text.match(
      /\b(RUB|USD|EUR|GBP|CHF|UAH|KZT|BYN|GEL|AMD|AZN|UZS|KGS|TJS|TMT|MDL|SEK|NOK|DKK|PLN|CZK|HUF|RON|BGN|RSD|BAM|ALL|MKD|ISK|TRY|CAD|BRL|MXN|ARS|COP|CLP|PEN|UYU|PYG|BOB|VES|CRC|GTQ|HNL|NIO|PAB|DOP|CUP|HTG|JMD|TTD|BBD|BSD|BZD|GYD|SRD|AWG|ANG|KYD|BMD|XCD|AED|SAR|QAR|KWD|BHD|OMR|JOD|ILS|IQD|IRR|SYP|LBP|YER|JPY|CNY|KRW|TWD|HKD|MOP|MNT|KPW|INR|PKR|LKR|BDT|NPR|MVR|BTN|AFN|THB|VND|SGD|MYR|IDR|PHP|MMK|KHR|LAK|BND|AUD|NZD|FJD|PGK|WST|TOP|VUV|SBD|XPF|EGP|MAD|TND|DZD|LYD|SDG|NGN|GHS|XOF|CVE|GMD|GNF|LRD|SLE|MRU|KES|TZS|UGX|ETB|RWF|BIF|DJF|ERN|SOS|MGA|MUR|SCR|KMF|SSP|XAF|CDF|STN|ZAR|BWP|MWK|ZMW|MZN|AOA|NAD|SZL|LSL)\b/i,
    );
    if (currencyMatch) {
